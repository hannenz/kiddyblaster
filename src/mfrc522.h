...
void mfrc522_pcd_read_register_multi(byte reg, byte count, byte *values, byte rxAlign);
void mfrc522_set_bit_mask(unsigned char reg, unsigned char mask);
void mfrc522_pcd_set_register_bit_mask(byte reg, byte mask);
void mfrc522_pcd_clear_register_bit_mask(byte reg, byte mask);
byte mfrc522_pcd_calculate_crc(byte *data, byte length, byte *result);
...
/////////////////////////////////////////////////////////////////////////////////////
byte mfrc522_pcd_transceive_data(byte *sendData, byte sendLen, byte *backData, byte *backLen, byte *validBits, byte rxAlign, bool checkCRC);
byte mfrc522_pcd_communicate_with_picc(byte command, byte waitIRq, byte *sendData, byte sendLen, byte *backData, byte *backLen, byte *validBits, byte rxAlign, bool checkCRC);
byte mfrc522_picc_request_a(byte *bufferATQA, byte *bufferSize);
byte mfrc522_picc_wakeup_a(byte *bufferATQA, byte *bufferSize);
byte mfrc522_picc_reqa_or_wupa(byte command, byte *bufferATQA, byte *bufferSize);
byte mfrc522_picc_select(Uid *uid, byte validBits);
...
// Support functions
/////////////////////////////////////////////////////////////////////////////////////
byte mfrc522_pcd_mifare_transceive(byte *sendData, byte sendLen, bool acceptTimeout);
// old function used too much memory, now name moved to flash; if you need char, copy from flash to memory
//const char *GetStatusCodeName(byte code);
const char* mfrc522_get_status_code_name(byte code);
byte mfrc522_picc_get_type(byte sak);
// old function used too much memory, now name moved to flash; if you need char, copy from flash to memory
//const char *PICC_GetTypeName(byte type);
const char* mfrc522_picc_get_type_name(byte type);
void mfrc522_picc_dump_to_serial(Uid *uid);
void mfrc522_picc_dump_mifare_classic_to_serial(Uid *uid, byte piccType, MIFARE_Key *key);
void mfrc522_picc_dump_mifare_classic_sector_to_serial(Uid *uid, MIFARE_Key *key, byte sector);
void mfrc522_picc_dump_mifare_ultralight_to_serial();
void mfrc522_mifare_set_access_bits(byte *accessBitBuffer, byte g0, byte g1, byte g2, byte g3);
...
byte mfrc522_mifare_two_step_helper(byte command, byte blockAddr, long data);
